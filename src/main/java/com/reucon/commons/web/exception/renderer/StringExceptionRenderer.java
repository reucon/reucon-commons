...
public class StringExceptionRenderer
{
    ...
    void writeExceptionReport(Date date, ExceptionStorageEntry entry, ExceptionReport exceptionReport) throws IOException
    {
